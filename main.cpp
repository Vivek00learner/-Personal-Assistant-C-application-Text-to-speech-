...
void greetings()
{
    ...
    if (time->tm_hour < 12)
    {
        cout << "Good Morning Master VIVEK " << endl;
        string phrase = "Good Morning Master VIVEK";
    ...
    {
        cout << "Good Afternoon Master VIVEK" << endl;
        string phrase = "Good Afternoon Master VIVEK";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
    ...
    {
        cout << "Good Evening Master VIVEK " << endl;
        string phrase = "Good Evening Master VIVEK";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout << "******************************************************" << endl;
        cout << "| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER VIVEK |" << endl;
        cout << "******************************************************" << endl
             << endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER VIVEK ";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if (password == "VIVEK")
        {
            ...
            do
            {
                cout << "\n<**********************************************************************************************>\n\n";
                cout << endl
                     << "How can i help you Master VIVEK...." << endl
                     << endl;

                string phrase = "How can i help you Master VIVEK";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout << "Hello Master VIVEK....." << endl;
                    string phrase = "Hello Master VIVEK";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout << "I'm a personal assistant created by Master VIVEK !!!" << endl;
                    string phrase = "I'm a personal assistant created by Master VIVEK !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout << "Good Bye Master VIVEK, see you soon!" << endl;
                    string phrase = "Good Bye Master VIVEK, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
